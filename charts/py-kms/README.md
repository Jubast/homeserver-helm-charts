...
**Homepage:** <https://github.com/Jubast/homeserver-helm-charts/tree/main/charts/py-kms>
...
helm repo update
helm install py-kms jubast-helm-charts/py-kms -f values.yaml
```
...
To uninstall the `py-kms` chart

```console
helm uninstall py-kms
```
...
| hostAliases | list | `[]` |  |
| image.digest | string | `"sha256:830c65dac504b2ebdff18e8126f3c66db06860f306a9703e15b598642b8d9de9"` |  |
...
| logFile | string | `"/tmp/pykms_logserver.log"` |  |
