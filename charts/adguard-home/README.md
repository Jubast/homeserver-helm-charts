...
![Version: 0.0.1](https://img.shields.io/badge/Version-0.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.107.64](https://img.shields.io/badge/AppVersion-v0.107.64-informational?style=flat-square)
...
| adguardConfig.users[0].password | string | `"changeme"` |  |
| affinity | object | `{}` |  |
| args | list | `[]` |  |
